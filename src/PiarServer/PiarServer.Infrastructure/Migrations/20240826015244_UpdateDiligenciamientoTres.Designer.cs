...
namespace PiarServer.Infrastructure.Migrations
{
    ...
    [Migration("20240826015244_UpdateDiligenciamientoTres")]
    partial class UpdateDiligenciamientoTres
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PiarServer.Domain.AjustesPiar.AjustePiar", b =>
                {
                    ...
                    b.Property<Guid?>("IdAjt")
                        .HasColumnType("uuid")
                        .HasColumnName("id_ajt");
                    ...
                    b.HasIndex("IdAjt")
                        .HasDatabaseName("ix_ajustes_piar_id_ajt");
            ...
            modelBuilder.Entity("PiarServer.Domain.BarrerasPiar.BarreraPiar", b =>
                {
                    ...
                    b.Property<Guid?>("IdBarr")
                        .HasColumnType("uuid")
                        .HasColumnName("id_barr");
                    ...
                    b.HasIndex("IdBarr")
                        .HasDatabaseName("ix_barreras_piar_id_barr");
            ...
            modelBuilder.Entity("PiarServer.Domain.EvaluacionesPiar.EvaluacionPiar", b =>
                {
                    ...
                    b.Property<Guid>("IdEva")
                        .HasColumnType("uuid")
                        .HasColumnName("id_eva");
                    ...
                    b.HasIndex("IdEva")
                        .HasDatabaseName("ix_evaluaciones_piar_id_eva");
            ...
            modelBuilder.Entity("PiarServer.Domain.MateriasPiar.MateriaPiar", b =>
                {
                    ...
                    b.HasIndex("IdMat")
                        .HasDatabaseName("ix_materias_piar_id_mat");
            ...
            modelBuilder.Entity("PiarServer.Domain.ObjetivosPiar.ObjetivoPiar", b =>
                {
                    ...
                    b.HasIndex("IdObj")
                        .HasDatabaseName("ix_objetivos_piar_id_obj");
            ...
            modelBuilder.Entity("PiarServer.Domain.AjustesPiar.AjustePiar", b =>
                {
                    b.HasOne("PiarServer.Domain.Ajustes.Ajuste", null)
                        .WithMany()
                        .HasForeignKey("IdAjt")
                        .HasConstraintName("fk_ajustes_piar_ajustes_ajuste_id");
            ...
            modelBuilder.Entity("PiarServer.Domain.BarrerasPiar.BarreraPiar", b =>
                {
                    b.HasOne("PiarServer.Domain.Barreras.Barrera", null)
                        .WithMany()
                        .HasForeignKey("IdBarr")
                        .HasConstraintName("fk_barreras_piar_barreras_barrera_id");
            ...
            modelBuilder.Entity("PiarServer.Domain.EvaluacionesPiar.EvaluacionPiar", b =>
                {
                    b.HasOne("PiarServer.Domain.Evaluaciones.Evaluacion", null)
                        .WithMany()
                        .HasForeignKey("IdEva")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_evaluaciones_piar_evaluaciones_evaluacion_id");
            ...
            modelBuilder.Entity("PiarServer.Domain.MateriasPiar.MateriaPiar", b =>
                {
                    b.HasOne("PiarServer.Domain.Materias.Materia", null)
                        .WithMany()
                        .HasForeignKey("IdMat")
                        .HasConstraintName("fk_materias_piar_materias_materia_id");
            ...
            modelBuilder.Entity("PiarServer.Domain.ObjetivosPiar.ObjetivoPiar", b =>
                {
                    ...
                    b.HasOne("PiarServer.Domain.Objetivos.Objetivo", null)
                        .WithMany()
                        .HasForeignKey("IdObj")
                        .HasConstraintName("fk_objetivos_piar_objetivos_objetivo_id");
                });
                    ...
                    b.OwnsOne("PiarServer.Domain.Piars.DiligenciamientoTres", "DiligenciamientoTres", b1 =>
                        {
                            ...
                            b1.Property<string>("ActsApo")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("diligenciamiento_tres_acts_apo");

                            b1.Property<string>("Compromisos")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("diligenciamiento_tres_compromisos");
                            ...
                            b1.Property<string>("InstEduA3")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("diligenciamiento_tres_inst_edu_a3");
